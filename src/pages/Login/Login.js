...
const oauth2 = (provider) => css`
    ...
    font-size: ${provider === "kakao" ? "30px" : "20ox"};
    cursor: pointer;
    &:hover {
        ...
        <div css={Container}>
            ...
            <main css={mainContainer}>
                <div css={authForm}>
                    ...
                    <LoginInput type="email" placeholder={"Type your username"}>
                        <FiUser />
                    </LoginInput>
            ...
            <div css={signupMessage}>Of Sign Up Using</div>

            <div css={auth2Container}>
